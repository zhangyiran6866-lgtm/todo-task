export default {
  ...
  home: {
    title: "My Space",
    subtitle: "Believe that beautiful things are on the way.",
    entryTasks: "Task Management",
    entryPointCloud: "Point Cloud Board",
    entryAnnotator: "Image Annotator",
  ...
  tasks: {
    ...
    setNow: "Set now",
    selectStartDate: "Pick a start time (optional)",
    selectDueDate: "Pick a due date",
    oneDay: "1 day",
    threeDays: "3 days",
    oneWeek: "1 week",
    cancelCreate: "Cancel",
    discardDraftConfirm: "Unsaved information will be cleared if you close. Continue?",
    timeRangeInvalid: "Start time cannot be later than due date",
  ...
  annotator: {
    ...
    errors: {
      ...
      uploadFirst: "Please upload an image before annotating",
    },
  },
  logs: {
    title: "Log Center",
