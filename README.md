...
TodoTask 是一个面向个人用户的**全栈任务管理系统**，采用 Tech-Noir 沉浸式科技风 UI 设计，支持任务 CRUD、JWT 认证、中英双语切换、多种霓虹主题色，并内置日志中心、3D 点云看板和图片标注工具。

## 🆕 最近新增功能

- 日志中心：支持按通道/级别/模块/时间范围筛选日志并查看详情
- 3D 点云看板：支持点云模型加载、Shader 模式切换与交互浏览
- 图片标注工具：支持上传图片、图形标注、撤销与导出
